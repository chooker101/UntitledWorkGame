...
//#include "halcyonic_descriptor_layout_docu.inl"
	class DescriptorLayout //Rename to descriptorlayout
	{
	private:
	...
	public:
		DescriptorLayout(ShaderStage shaderStage, LayoutBindingDescriptor layoutBinding, uint32_t bindingLocation);
